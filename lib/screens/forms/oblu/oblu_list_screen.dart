...
import 'oblu_form_screen.dart';

class ObluListScreen extends StatefulWidget {
  const ObluListScreen({super.key});

  @override
  State<ObluListScreen> createState() => _ObluListScreenState();
}

class _ObluListScreenState extends State<ObluListScreen> {
  ...
  Future<void> _loadForms() async {
    ...
    try {
      ...
      if (employeeData != null) {
        final loadedForms =
            await _formsService.getObluForms(employeeData['emp_id']);
        setState(() {
          forms = loadedForms;
        });
      }
            ...
            : forms.isEmpty
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onPressed: () => Get.toNamed(AppRoutes.obluNew),
                        ),
                      ],
                    ),
                  )
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Get form type text
                      String formType;
                      switch (form['sub_type']) {
                        case 'ob':
                          formType = 'OFFICIAL BUSINESS';
                          break;
                        case 'late':
                          formType = 'LATE';
                          break;
                        ...
                        case 'ot':
                          ...
                          break;
                        default:
                          formType = form['sub_type']?.toUpperCase() ?? '';
                      }
